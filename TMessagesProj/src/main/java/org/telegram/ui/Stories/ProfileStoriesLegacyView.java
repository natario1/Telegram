...
public class ProfileStoriesLegacyView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    private class StoryCircle {
        public StoryCircle(TL_stories.StoryItem storyItem) {
            ...
            this.imageReceiver.setParentView(ProfileStoriesLegacyView.this);
            if (attached) {
        ...
        boolean read = false;
        float scale = 1;
        final AnimatedFloat readAnimated = new AnimatedFloat(ProfileStoriesLegacyView.this, 420, CubicBezierInterpolator.EASE_OUT_QUINT);
        final AnimatedFloat indexAnimated = new AnimatedFloat(ProfileStoriesLegacyView.this, 420, CubicBezierInterpolator.EASE_OUT_QUINT);
        final AnimatedFloat scaleAnimated = new AnimatedFloat(ProfileStoriesLegacyView.this, 420, CubicBezierInterpolator.EASE_OUT_QUINT);
    ...
    public ProfileStoriesLegacyView(Context context, int currentAccount, long dialogId, boolean isTopic, @NonNull View avatarContainer, ProfileActivity.AvatarImageView avatarImage, Theme.ResourcesProvider resourcesProvider) {
        super(context);
    ...
    public void updateStories(boolean animated, boolean asUpdate) {
        if (isTopic) {
            return;
        }
...
//                float cx = left + r + ix;
    ...
    private final StoryViewer.PlaceProvider provider = new StoryViewer.PlaceProvider() {
        ...
        public boolean findView(long dialogId, int messageId, int storyId, int type, StoryViewer.TransitionViewHolder holder) {
            ...
            holder.avatarImage = null;
            holder.view = ProfileStoriesLegacyView.this;
            holder.clipTop = 0;
            holder.clipBottom = AndroidUtilities.displaySize.y;
            holder.clipParent = (View) getParent();
            if (a != null && b != null) {
